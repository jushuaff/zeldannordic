...
<div class="w-100 d-flex">
	...
	<div class="w-100 toggled" id="main">
		...
		<div id="main-div">
			...
			<div id="body-row">
				<?php $emp_list = $this->users_model->get_all_desc_by_id($archive=0); ?>
				                    ...
				                    echo '
				                        <tr tr-id="'.$emp_list['id'].'">
				                            ...
				                            <td class="d-flex justify-content-center">
				                                <button class="btn edit edit-profile" user-id="'.$emp_list['id'].'" data-toggle="modal" data-target="#employee-cru-modal" title="Edit employee info" user-type="'.$emp_list['user_type'].'"><i class="fas fa-edit"></i> Edit</button>
				                                <button class="btn password update-password" user-id="'.$emp_list['id'].'" data-toggle="modal" data-target="#update-password-modal" title="Reset password"><i class="fas fa-key"></i> Password</button>
				                               	<button class="btn archive archive-user" user-id="'.$emp_list['id'].'" data-toggle="modal" data-target="#archive-user-modal" title="Archive employee" archive-value="1"><i class="fas fa-archive"></i> Archive</button>
				                            </td>
				                        </tr>
				                    ';
				                endif;
